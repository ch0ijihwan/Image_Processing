...
color2gray = cv2.imread("../0403_5/training_chap04/read_color.jpg", cv2.IMREAD_GRAYSCALE)
color2color = cv2.imread("../0403_5/training_chap04/read_color.jpg", cv2.IMREAD_COLOR)
