...
#         cv2.drawChessboardCorners(images, bSize, corners, ret)           # 코너 표시
#         cv2.imshow("file", images)
#     return ret, np.array(corners, np.float32)
#
# def calibrate_correct(points, imagePoints, images):
#     size = images.shape[1::-1]                       # 행태와 크기는 역순
...
#     undistorted = cv2.undistort(images, ret[1], ret[2], None, newSacle)
#     x, y, w, h = roi
